...
public class ExcelUtility {
	...
	public void fillGreenColor(String sheetName, int rownum, int celnum) throws IOException
	{
	...
	public void fillRedColor(String sheetName, int rownum, int celnum) throws IOException
	{
